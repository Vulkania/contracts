...
contract Vulkania is Context, IBEP20, Ownable {
    ...
    uint256 private _tTotal = 40000000 * _DECIMALFACTOR;
    ...
    uint256 private constant _MAX_TX_SIZE = 40000000 * _DECIMALFACTOR;
